...
Feature: Parabank logout testing
  ...
  @TC1
  Scenario Outline: As a logged-in user, I want to logout successfully Parabank website
    ...
    Examples: 
      ...
      | https://parabank.parasoft.com/parabank/index.htm?ConnType=JDBC | monira   |   123456 |
